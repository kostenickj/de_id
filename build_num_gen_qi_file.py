...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print 'Usage: python build_num_gen_qi_file.py qi_pickle_file_in qi_gen_file_out'
        sys.exit(1)
    ...
    for l in qi_in_l:
        l[6] = get_gen_val(yob_map, l[6])
        l[8] = get_gen_val(post_map, l[8])
        l[9] = get_gen_val(votes_map, l[9])
        l[10] = get_gen_val(endorse_map, l[10])
        l[11] = get_gen_val(thread_map, l[11])
        l[12] = get_gen_val(comments_map,l[12])
